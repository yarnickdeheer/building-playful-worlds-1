...
public class SwitchScenes : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (trig ==true && Input.GetKey(KeyCode.E) && scene.name == "void" || trig == true && Input.GetKey(KeyCode.E) && scene.name == "fire" ||
            trig == true && Input.GetKey(KeyCode.E) && scene.name == "water" || trig == true && Input.GetKey(KeyCode.E) && scene.name == "ground")
        {
